...
# 4) on matlab, go to the session folder and run prepare_align_mask to create overlay.dat 
...
# AB, last update 20151102

# argument $1 = folder name of run (e.g., ep2d_22027)
